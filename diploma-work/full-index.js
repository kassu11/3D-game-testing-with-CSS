...
function movePlayer(deltaTime) {
	const moveSpeed = (gameMode === "EDIT" ? 3 : (activeKeys.has("ShiftLeft") ? 1.75 : 1)) * (600 * deltaTime) / 1000;
	...
	if (activeKeys.has("Space") && gameMode === "EDIT") {
		position.y -= moveSpeed;
	}
	if (activeKeys.has("ShiftLeft") && gameMode === "EDIT") {
		position.y += moveSpeed;
	}
